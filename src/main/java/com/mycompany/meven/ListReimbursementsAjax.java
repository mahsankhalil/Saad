 ...
 * @author Faizan-Ahmad
 */
@WebServlet(name = "ListReimbursementsAjax", urlPatterns = {"/ListReimbursementsAjax"})
public class ListReimbursementsAjax extends HttpServlet {

    private ReimburseDbUtil reimburseDbUtil= new ReimburseDbUtil();
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for(Reimbursement obj : reimbursements)
            {
                ...
                html=html+"<td><a href='./ReimbursementControllerServlet?command=LOAD&reimbursementId="+obj.getReimbursementId()+"'>Update</a>"
                        + "<a href='#'" + "onclick='return myDelete("+obj.getReimbursementId()+");'>" +
"						Delete</a>" +
"						</td></tr>";
            }
            out.println(html);
            ...
            Logger.getLogger(ListReimbursementsAjax.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
